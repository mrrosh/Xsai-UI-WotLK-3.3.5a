...
obj[17]	= { label="技能格挡", tooltip="显示格挡技能攻击"}
obj[18]	= { label="法术抵抗", tooltip="显示抵抗法术攻击"}
obj[19]	= { label="技能吸收", tooltip="显示吸收技能伤害"}
obj[20]	= { label="技能免疫", tooltip="显示免疫技能伤害"}
obj[21]	= { label="技能反射", tooltip="显示反射技能伤害"}
obj[22]	= { label="法术打断", tooltip="显示打断法术"}
obj[23]	= { label="治疗", tooltip="显示被治疗"}
obj[24]	= { label="爆击治疗", tooltip="显示被治疗爆击"}
obj[25]	= { label="持续治疗", tooltip="显示被持续治疗"}
obj[26]	= { label="环境伤害", tooltip="显示环境伤害（如跌落，窒息，熔岩等）"}
...
obj[17]	= { label="技能格挡", tooltip="显示宠物格挡技能攻击"}
obj[18]	= { label="法术抵抗", tooltip="显示宠物抵抗法术攻击"}
obj[19]	= { label="技能吸收", tooltip="显示宠物吸收技能伤害"}
obj[20]	= { label="技能免疫", tooltip="显示宠物免疫技能伤害"}
obj[21]	= { label="治疗", tooltip="显示宠物被治疗"}
obj[22]	= { label="治疗爆击", tooltip="显示宠物被治疗爆击"}
obj[23]	= { label="持续治疗", tooltip="显示宠物被持续治疗"}
...
obj[18]	= { label="技能格挡", tooltip="显示敌人格挡技能攻击"}
obj[19]	= { label="法术抵抗", tooltip="显示敌人抵抗法术攻击"}
obj[20]	= { label="技能吸收", tooltip="显示敌人吸收法术伤害"}
obj[21]	= { label="技能免疫", tooltip="显示敌人免疫技能伤害"}
obj[22]	= { label="技能反射", tooltip="显示敌人反射技能伤害"}
obj[23]	= { label="法术打断", tooltip="显示法术攻击被打断"}
obj[24]	= { label="技能闪避", tooltip="显示技能攻击被闪避"}
obj[25]	= { label="治疗", tooltip="显示治疗目标"}
obj[26]	= { label="治疗爆击", tooltip="显示爆击治疗目标"}
obj[27]	= { label="持续治疗", tooltip="显示持续治疗目标"}
obj[28] = { label="驱散", tooltip="显示驱散."}
...
obj[18]	= { label="技能格挡", tooltip="显示宠物的技能攻击被格挡"}
obj[19]	= { label="法术抵抗", tooltip="显示宠物的法术攻击被抵抗"}
obj[20]	= { label="技能吸收", tooltip="显示宠物的技能伤害被吸收"}
obj[21]	= { label="技能免疫", tooltip="显示宠物的技能伤害被免疫"}
obj[22]	= { label="技能闪避", tooltip="显示宠物的技能攻击被闪避"}
obj[23] = { label="驱散", tooltip="显示宠物的驱散."}
...
obj["UNIT_MANA"]				= "法力值改变"
obj["UNIT_ENERGY"]				= "能量值改变"
obj["UNIT_RAGE"]				= "怒气值改变"
obj["UNIT_RUNIC_POWER"]			= "符文能量值改变"
