...
RaidInfo_Box:SetPoint("TOPLEFT", LootFrame_Box, "BOTTOMLEFT", 0, -16)
...
-- QuestLog
-- -----
local QuestLog_Box = CreateFrame("FRAME", "FramesResizedPanel_QuestLog_Box", panel, "OptionsBoxTemplate")
QuestLog_Box:SetHeight(60)
QuestLog_Box:SetWidth(186)
QuestLog_Box:SetPoint("TOPLEFT", RaidInfo_Box, "BOTTOMLEFT", 0, -16)
QuestLog_Box:SetBackdropBorderColor(0.4, 0.4, 0.4);
QuestLog_Box:SetBackdropColor(0.15, 0.15, 0.15);
_G["FramesResizedPanel_QuestLog_BoxTitle"]:SetText("QuestLog");

local QuestLog_Resize = CreateFrame("CHECKBUTTON", "FramesResizedPanel_QuestLog_Resize", panel, "InterfaceOptionsSmallCheckButtonTemplate")
QuestLog_Resize:SetPoint("TOPLEFT", QuestLog_Box, "TOPLEFT", 8, -6)
_G["FramesResizedPanel_QuestLog_ResizeText"]:SetText("Resize")
QuestLog_Resize.setFunc = function(v) FramesResized_SV.QuestLog_Resize = (v == "1") end

local QuestLog_Moveable = CreateFrame("CHECKBUTTON", "FramesResizedPanel_QuestLog_Moveable", panel, "InterfaceOptionsSmallCheckButtonTemplate")
QuestLog_Moveable:SetPoint("TOPLEFT", QuestLog_Resize, "BOTTOMLEFT", 0, 4)
_G["FramesResizedPanel_QuestLog_MoveableText"]:SetText("Moveable")
QuestLog_Moveable.setFunc = function(v) FramesResized_SV.QuestLog_Moveable = (v == "1") end
...
TraidSkillUI_Box:SetPoint("TOPLEFT", LootFrame_Box, "TOPRIGHT", 8, 0)
...
TrainerUI_Box:SetPoint("TOPLEFT", TraidSkillUI_Box, "BOTTOMLEFT", 0, -16)
...
panel.refresh = function()
	...
	QuestLog_Resize:SetChecked(FramesResized_SV.QuestLog_Resize)
	QuestLog_Moveable:SetChecked(FramesResized_SV.QuestLog_Moveable)
