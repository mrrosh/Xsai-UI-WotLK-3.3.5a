...
L:SetOptionLocalization({
	...
	TimerSpark			= "Показать таймер призыва Искры мощи",
	TimerVortex			= "Показать таймер Воронки",
	TimerBreath			= "Показать таймер Дыхания чар",
	TimerVortexCD		= "Показать таймер перезарядки Воронки (неточно)",
