...
local function CreateStyle(self, unit)
	...
	self.Health.Text:SetPoint('RIGHT', self.Health, -2, 19)
	...
	if(unit == 'player' or unit == 'pet') then
		...
		power:SetPoint('LEFT', self.Health, 0, 19)
    power:SetFont(font, fontsize, "OUTLINE")
		...
		info:SetPoint('LEFT', self.Health, 0, 20)
		info:SetPoint('RIGHT', self.Health.Text, 'LEFT')
		info:SetFont(font, fontsize2, "OUTLINE")
