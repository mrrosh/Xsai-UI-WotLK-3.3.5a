...
ACBFactory.Check = function(index)
	local f = CreateFrame("CheckButton",nil,AzCastBarOptions,"OptionsSmallCheckButtonTemplate");
	f:SetWidth(26);
	f:SetHeight(26);
...
local function DropDown_CreateMenu()
	...
	menu.scroll:SetScript("OnVerticalScroll",function(self,offset) FauxScrollFrame_OnVerticalScroll(self,offset,DropDown_ItemHeight,DropDown_UpdateList); end); -- Az: wotlk change
