...
-- Shared Media
local SML = LibStub and LibStub("LibSharedMedia-3.0",1) or nil;

SML:Register("statusbar","_MOmooo","Interface\\AddOns\\oUF_Lyn\\textures\\statusbar");
SML:Register("font","_sfgsdfsdf","Interface\\AddOns\\oUF_Lyn\\fonts\\font.ttf");
